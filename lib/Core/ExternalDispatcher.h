...
namespace klee {
  ...
  private:
    ...
    llvm::Function *createDispatcher(llvm::Function *f, llvm::Instruction *i, bool intrinsic = false);
  ...
  public:
     ...
     * into args[0].
     */
    bool executeCall(llvm::Function *function, llvm::Instruction *i, uint64_t *args, bool intrinsic = false);
    void *resolveSymbol(const std::string &name);
    llvm::Module* getDispatchModule() { return dispatchModule; }
  };  
}
