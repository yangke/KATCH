...
bool ExternalDispatcher::executeCall(Function *f, Instruction *i, uint64_t *args, bool intrinsic) {
  ...
  if (it == dispatchers.end()) {
    ...
    dispatcher = createDispatcher(f,i,intrinsic);
...
Function *ExternalDispatcher::createDispatcher(Function *target, Instruction *inst, bool intrinsic) {
